...
class Ui_MainWindow(object):
    ...
    def delete_team(self):
        ...
        if ok == True:
            ...
            if self.team in self.AllTeams:
                ...
                cricket.commit()
                self.messagebox('Hurry !!','%s Team Successfully Deleted'%(self.team))
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background-color: #DCDADA")
        ...
        self.SelectedPlayers.setStyleSheet("background-color: white")
        ...
        self.PlayersList.setStyleSheet("background-color: white")
